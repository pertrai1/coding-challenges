...
# [All Paths from Source Lead to Destination](https://leetcode.com/problems/all-paths-from-source-lead-to-destination) ![](https://img.shields.io/badge/Medium-orange)
